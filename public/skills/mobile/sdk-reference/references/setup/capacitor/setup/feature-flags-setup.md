# Feature Flags Setup - Capacitor

Feature Flags in Airship allow you to remotely control feature availability and configuration in your Capacitor app.

**Requirements**: Airship Capacitor SDK 17.1+
